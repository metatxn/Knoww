/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./cloudflare-env.d.ts` (hash: 5a48c4190f62ddc9b72c7080c730967f)
// Runtime types generated with workerd@1.20260903.1 2026-07-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_AUTH_RATE_LIMITER: RateLimit;
	MCP_EDGE_RATE_LIMITER: RateLimit;
	MCP_FREE_PRINCIPAL_RATE_LIMITER: RateLimit;
	MCP_FREE_TOOL_RATE_LIMITER: RateLimit;
	MCP_AUTH_MODE: "dev-bypass" | "oauth-required";
	MCP_CANONICAL_RESOURCE: "http://localhost:8787/mcp" | "https://mcp.knoww.app/mcp";
	MCP_ALLOWED_HOSTNAMES: "localhost,127.0.0.1" | "mcp.knoww.app";
	MCP_ALLOWED_ORIGIN_HOSTNAMES: "localhost,127.0.0.1" | "mcp.knoww.app,knoww.app,www.knoww.app";
	POSTHOG_HOST: "https://us.i.posthog.com";
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	MCP_AUTH_CHALLENGES: DurableObjectNamespace<import("./src/index").WalletChallengeStore>;
	POSTHOG_PROJECT_API_KEY?: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WalletChallengeStore";
	}
	interface LocalEnv {
		OAUTH_KV: KVNamespace;
		MCP_AUTH_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MCP_AUTH_MODE" | "MCP_CANONICAL_RESOURCE" | "MCP_ALLOWED_HOSTNAMES" | "MCP_ALLOWED_ORIGIN_HOSTNAMES" | "POSTHOG_HOST" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "POSTHOG_PROJECT_API_KEY">> {}
}
