 ...
 *
 * Example: /api/polymarket/markets/price-history/[tokenId]?startTs=1754353491&fidelity=720
 */
/**
 * @openapi
 * /api/polymarket/markets/price-history/{tokenId}:
 *   get:
 *     summary: Fetch /api/polymarket/markets/price-history/{tokenId}.
 *     tags: [Markets]
 *     responses:
 *       200:
