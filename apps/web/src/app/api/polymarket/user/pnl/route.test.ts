...
describe("GET /api/polymarket/user/pnl", () => {
  it("returns 504 when an upstream request exceeds its deadline", async () => {
    ...
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/pnl?user=0x0000000000000000000000000000000000000001"
    );
  ...
  it("returns a sanitized validation error for invalid query parameters", async () => {
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/pnl?user=0x0000000000000000000000000000000000000001&period=forever"
    );
  ...
  it("aggregates monetary values with decimal arithmetic", async () => {
    ...
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/pnl?user=0x0000000000000000000000000000000000000001&includeHistory=true"
    );
  ...
  it("normalizes Unix seconds, numeric strings, and ISO activity timestamps", async () => {
    ...
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/pnl?user=0x0000000000000000000000000000000000000001&period=1d&includeHistory=true"
    );
  ...
  it("ignores non-trade and malformed activity rows", async () => {
    ...
    const response = await GET(
      new NextRequest(
        "https://knoww.app/api/polymarket/user/pnl?user=0x0000000000000000000000000000000000000001&period=all&includeHistory=true"
      )
    );
  ...
  it("includes and deduplicates qualifying activity from a second page", async () => {
    ...
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/pnl?user=0x0000000000000000000000000000000000000001&period=7d"
    );
