...
describe("GET /api/polymarket/user/positions", () => {
  ...
  it("merges open and redeemable positions with one merged page slice", () => {
    const source = readSource("src/app/api/polymarket/user/positions/route.ts");
  ...
  it("counts winning redeemable rows toward the returned position limit", async () => {
    ...
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/positions?user=0x0000000000000000000000000000000000000001&limit=2"
    );
  ...
  it("paginates after merging open and winning redeemable positions", async () => {
    ...
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/positions?user=0x0000000000000000000000000000000000000001&limit=2&offset=2"
    );
  ...
  it("preserves deep offset pages instead of only scanning from the first upstream page", async () => {
    ...
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/positions?user=0x0000000000000000000000000000000000000001&limit=2&offset=600"
    );
  ...
  it("slices deep offsets from the merged row space, not the raw upstream space", async () => {
    ...
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/positions?user=0x0000000000000000000000000000000000000001&limit=2&offset=598"
    );
  ...
  it("ends pagination explicitly past the merged scan ceiling instead of misaligned rows", async () => {
    ...
    const req = new NextRequest(
      "https://knoww.app/api/polymarket/user/positions?user=0x0000000000000000000000000000000000000001&limit=50&offset=1000"
    );
