 ...
 *
 * Flow:
 *   Browser    → POST /api/polymarket/relayer/{path} → this route → Polymarket relayer/{path}
 *   Extension  → POST /api/polymarket/relayer/{path} → this route → Polymarket relayer/{path}
 *
 * Auth strategy:
...
/**
 * @openapi
 * /api/polymarket/relayer/{path}:
 *   get:
 *     summary: Fetch /api/polymarket/relayer/{path}.
 *     tags: [Relayer]
 *     responses:
 *       200:
 ...
 * /api/polymarket/relayer/{path}:
 *   post:
 *     summary: Create or proxy /api/polymarket/relayer/{path}.
 *     tags: [Relayer]
 *     responses:
 *       200:
 *         description: Successful response.
