...
// OpenNext emits this module during its build.
...
// Cron settings can be overridden per deployment beyond the generated literals.
interface WorkerEnv
  extends Omit<
    CloudflareEnv,
    | "AGENT_CRON_ENABLED"
    | "AGENT_CRON_EXECUTION_MODE"
    | "AGENT_CRON_LOCK_LEASE_MS"
    | "INDEXNOW_CRON_ENABLED"
  > {
  AGENT_DB: D1Database;
