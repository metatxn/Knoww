    ...
    <div className="flex items-center gap-2">
      ...
      {hasActiveFilters && (
        <button
          ...
          className="inline-flex items-center justify-center px-2.5 py-1.5 rounded-lg text-[13px] font-medium text-destructive hover:bg-destructive/10 transition-all active:scale-[0.97] shrink-0"
              ...
              {TAB_CATEGORIES.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex items-center gap-1.5 px-3.5 py-2 rounded-xl font-semibold text-[13px] whitespace-nowrap transition-all duration-200 shrink-0 active:scale-[0.97] ${
                      isActive
                ...
                {TAB_CATEGORIES.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-full font-semibold text-xs sm:text-sm whitespace-nowrap transition-all duration-200 shrink-0 active:scale-95 ${
                        isActive
